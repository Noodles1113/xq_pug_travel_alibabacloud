...
//
//import com.pug.cloud.loadbalancer.NacoWeightRule;
...
//        // 自定义负载均衡方式
//        return new NacoWeightRule(loadBalancerClientFactory.getLazyProvider(name, ServiceInstanceListSupplier.class), name);
//    }
//}
